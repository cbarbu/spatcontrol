...
#=======================
T <- 0.3 # 0.87 # efecto de calles (bajo de 1 es barrera)
f <- 9 #8.55 # distancia caracteristica de la relacion espacial
Ku<- 0.48 #2.15 # error espacial ( mas grande es menos el error)
Kv<- 170 # error no espacial ( mas grande es menos el error)
mu <- -1.3 # fuerza inicial del preditor espacial (negativo es probabilidad de positividad menos de 0.5)
...
muPriorObs<- NULL # 0: prior at 0.5 proba of +, usually not realistic
