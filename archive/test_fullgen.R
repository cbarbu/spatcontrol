...
set.seed(777)
dbFit<-fit.spatautocorel(db=db,cofactors=c("CU","PE","oanimal","I.NO","P.NO"),nbiterations=-1,nocheck=FALSE,use.v=FALSE)
...
y<-w
v<-w
Kv<-NULL # no v component if NULL  
